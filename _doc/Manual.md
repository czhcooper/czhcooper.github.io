...
```yml
# Site settings
title: Czh Blog             # title of your website
SEOTitle: Czh Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Czh Blog”** but I want the title shows in search engine is **“黄玄的博客 | Czh Blog”** which is multi-language.
